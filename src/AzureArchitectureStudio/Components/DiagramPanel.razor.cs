...
namespace AzureArchitectureStudio.Components
{
    public partial class DiagramPanel : IDisposable
    {
        ...
        private async Task HandleDrop(DragEventArgs e)
        {
            try
            {
                ...
                if (stencil.Category != Models.StencilCategory.Gallery)
                {
                    ...
                    if (!result)
                    {
                        await messageService.ErrorAsync(message);
                        return;
                    }
                    diagram.Batch(() =>
                    {
            ...
            {
                await messageService.InfoAsync("The component is not implemented yet.");
            }
        }
        ...
        private async Task LoadReferenceArch(string refArchPath)
        {
            ...
            try
            {
                var httpClient = _clientFactory.CreateClient("AzureArchitectureStudio.ResourceAccess");
