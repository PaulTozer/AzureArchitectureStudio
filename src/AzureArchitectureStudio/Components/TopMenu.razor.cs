    ...
    public partial class TopMenu
    {
        ...
        private async Task OpenExportDrawer()
        {
            ...
            drawerRef.OnClosed = async result =>
            {
                ...
                {
                    await messageService.WarnAsync("There is nothing to export.");
                    return;
                }
        ...
        private async Task ExportBicep()
        {
            ...
            if (!string.IsNullOrEmpty(bicep.Error))
            {
                ...
                await messageService.ErrorAsync($"{bicep.Error}");
                return;
            }
        ...
        private async Task SaveDiagram(string designName)
        {
            ...
            {
                await messageService.WarnAsync("There is nothing to save.");
                return;
            }
            ...
            {
                await messageService.SuccessAsync("The design is saved successfully.");
            }
            else
            {
                await messageService.ErrorAsync($"Failed to save the design. Error code: {statusCode}");
            }
        }
        ...
        private async Task LoadDiagram(string designName)
        {
            ...
            if (diagramGraph == null)
            {
                await messageService.ErrorAsync("Cannot load the diagram.");
            }
            else
            {
