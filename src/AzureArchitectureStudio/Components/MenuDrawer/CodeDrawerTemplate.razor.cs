...
namespace AzureArchitectureStudio.Components.MenuDrawer
{
    internal record DeployStepsState
    {
    ...
    public partial class CodeDrawerTemplate
    {
        ...
        private DeployStepsState _stepsStatus = new();

        private AntDesign.StepsStatus GetStepsStatus() => _stepsStatus.Status switch
        {
            "error" => AntDesign.StepsStatus.Error,
            "process" => AntDesign.StepsStatus.Process,
